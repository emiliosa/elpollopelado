    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group {{ $errors->has('razon_social') ? 'has-error' : ''}}">
            <div class="cols-sm-10">
                ...
                {!! Form::text('razon_social', isset($cliente) ? $cliente->razon_social : null, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group {{ $errors->has('identificacion') ? 'has-error' : ''}}">
            <div class="cols-sm-10">
                ...
                {!! Form::text('identificacion', isset($cliente) ? $cliente->identificacion : null, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group {{ $errors->has('nombre') ? 'has-error' : ''}}">
            <div class="cols-md-6">
                ...
                {!! Form::text('nombre', isset($cliente) ? $cliente->nombre : null, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <div class="form-group {{ $errors->has('apellido') ? 'has-error' : ''}}">
            <div class="cols-sm-6">
                ...
                {!! Form::text('apellido', isset($cliente) ? $cliente->apellido : null, ['class' => 'form-control', 'disabled' => 'disabled']) !!}
